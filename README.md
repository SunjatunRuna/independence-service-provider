...
Open [https://service-provider-auth.web.app](http://localhost:3000) to view it in your browser.

## Home Food Catering Website: Delicious
- Used font awesome icon
- firebase authentication
- implement email verification
- useAuthState, useCreateUserWithEmailAndPassword, useSignInWithEmailAndPassword
- useSendPasswordReset, use toast for password reset
